...
main_pkgs=(atool base base-devel bash-completion bat eza fd linux linux-firmware linux-headers man-db man-pages texinfo openssh pacman-contrib ripgrep fzf sudo rsync zoxide wget "$microcode" grub reflector efibootmgr exfatprogs lostfiles namcap)
